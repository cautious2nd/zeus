/**
 * Author : chiziyue
 * Date : 2021年8月24日 下午3:54:26
 * Title : org.scaffold.common.http.result.ResultStatus.java
 *
**/
package org.scaffold.common.http.result;
...
public enum ResultStatus {
	...
	private ResultStatus(String statusCode, String message) {
	...
	public static ResultStatus getValue(String code) {
