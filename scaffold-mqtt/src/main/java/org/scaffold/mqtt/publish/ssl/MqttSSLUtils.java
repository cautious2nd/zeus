package org.scaffold.mqtt.publish.ssl;
...
public class MqttSSLUtils {
    ...
    /**
     * // 设置 SSL/TLS 连接地址
     * String broker = "ssl://broker.emqx.io:8883";//ssl端口默认8883
     * // 设置 socket factory
     * String caFilePath = "/cacert.pem";
     * String clientCrtFilePath = "/client.pem";
     * String clientKeyFilePath = "/client.key";
     * SSLSocketFactory socketFactory = MqttSSLUtils.getSocketFactory(caFilePath, clientCrtFilePath, clientKeyFilePath, "");
     * // MqttConnectOptions
